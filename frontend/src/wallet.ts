...
export async function getShop(accountId: string): Promise<UnitDef[]> {
  return viewCall<UnitDef[]>(BOARD_CONTRACT_ID, "get_shop", {
    player: accountId,
  });
}

export async function getBoard(accountId: string): Promise<PlayerState> {
  return viewCall<PlayerState>(BOARD_CONTRACT_ID, "get_board", {
    player: accountId,
  });
}
...
export async function getCurrentState(
  ...
  return viewCall<PlayerState | null>(BOARD_CONTRACT_ID, "get_current_state", {
    player: accountId,
  });
}
